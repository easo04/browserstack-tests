...
public class Mobilebis_EAQSWT_SEL_Habitation_locataire extends SeleniumTest {
    @Test
    public void Soumission_simple() throws Exception {
        ...
        //{
        //  WebDriverWait waitbandeaucookies = new WebDriverWait(driver,Duration.ofSeconds(90));
        //  waitbandeaucookies.until(ExpectedConditions.elementToBeClickable(By.cssSelector("//div[@id='cookiesjsr']/div/div/div[2]/button[2]")));
        //}
  
        //new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='cookiesjsr']/div/div/div[2]/button[2]"))).click();
        //if(driver.findElement(By.xpath("//div[@id='cookiesjsr']/div/div/div[2]/button[2]"))!= null){
        //   driver.findElement(By.xpath("//div[@id='cookiesjsr']/div/div/div[2]/button[2]")).click();
        //  }
        {
        ...
        driver.findElement(By.xpath("//button[@id='promutuelResidencePicker_iconResidenceType_tenant']/div/div/i")).click();
        ...
        driver.findElement(By.xpath("//li[2]/div/div/span")).click();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[2]/div[2]/div/div/div/input")).click();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[2]/div[2]/div/div/div/input")).clear();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[2]/div[2]/div/div/div/input")).sendKeys("1");
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[3]/div[2]/div/div/div/div/div/div/input")).click();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[3]/div[2]/div/div/div/div/div/div/input")).clear();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[3]/div[2]/div/div/div/div/div/div/input")).sendKeys("2020-01-01");
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[4]/div[2]/div/div/div/input")).click();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[4]/div[2]/div/div/div/input")).clear();
        driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[4]/div[2]/div/div/div/input")).sendKeys("50000");
        driver.findElement(By.xpath("//div[@id='promutuelDropdown-wrapper']/div")).click();
        driver.findElement(By.xpath("//li[5]/div/div/span")).click();
        driver.findElement(By.xpath("//div[@id='promutuelDropdown-wrapper']/div/div/div")).click();
        driver.findElement(By.xpath("//li[3]/div/div/span")).click();
