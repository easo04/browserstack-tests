...
public class Mobilebis_EAQSWT_SEL_Habitation_proprietaire extends SeleniumTest {
    @Test
    public void Soumission_simple() throws Exception {
        ...
        if(driver.findElements(By.cssSelector("button.cookiesjsr-btn.important.allowAll")).size()>0) {
          ...
          driver.findElement(By.xpath("//button[@id='promutuelResidencePicker_iconResidenceType_owner']/div/div/i")).click();
          ...
          driver.findElement(By.xpath("//div[2]/div[2]/div[2]/div/div/div/div/div[2]/div/div/div/div/div")).click();
          ...
          driver.findElement(By.xpath("//div[@id='promutuelBuildingInfoCardWrapper']/div/div[6]/div[2]/div/div/div/input")).sendKeys("350000");
